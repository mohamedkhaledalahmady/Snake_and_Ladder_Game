...
Button::Button(std::string button_str, sf::Vector2f button_size, sf::Vector2f button_position, int charSize, sf::Color button_background, sf::Color button_text_color)
{
	...
	this->button_pos_x = button_position.x;
	this->button_pos_y = button_position.y;
	if (!this->font.loadFromFile("E:/fonts/Open_Sans/OpenSans-SemiBoldItalic.ttf"))
		printf("Error!!\n");
	this->text.setFont(this->font);
	this->text.setString(button_str);
