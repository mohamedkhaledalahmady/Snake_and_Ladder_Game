...
using namespace std::chrono;	// to use its functions without library naem in beginning
#define escape 27				// Ascii for Escape button keyboard
#define step 61.2				// step of movement
#define MAX 100					// Max number in snake and ladder board
#define start 1					// start of snake and ladder board
#define MAX_Dice 6				// Maximum number can appear in dice
#define Window_Width 650		// Width of Window
#define Window_Hight 580		// Hight of Window
#define Image_Width 532			// background image Width
#define Image_Hight 534			// background image Hight
